...
const UserContact = require("./Routes/Users/UserContact");
const UserCarousel = require("./Routes/Users/UserCarousel");
const UserCountryRecord = require("./Routes/Users/UserCountryRecord");
...
app.use("/", UserRoutes);
app.use("/", UserContact);
app.use("/", UserCarousel);
app.use("/", UserCountryRecord);
